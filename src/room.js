...
const Room = function(server, config) {
  ...
  const usersApi = Users(io, sockets)
  ...
  io.on("connection", function(socket) {
    const user = User(socket, sockets);
    ...
    socket.on("disconnect", function() {
      ...
      usersApi.userDisconnection(socket.id)
      ...
      console.log(colors.yellow(`Users remaining ${users.size}`))
    })
    ...
    usersApi.userConnection(socket.id)
